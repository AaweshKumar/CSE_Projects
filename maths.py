...
if __name__ == "__main__":
    ...
    print("spherical_harmonic:", spherical_harmonic(0, 0, 0, 0))   # ~0.2821
    print("prob density:", probability_density(a0, 0.5, 0.5, 1, 0, 0, 1))  # float > 0
    print("cartesian:", to_cartesian(1.0, math.pi/4, math.pi/4))
    print("energy n=1:", get_energy(1, 1))   # -13.6
    print("energy n=2:", get_energy(2, 1))   # -3.4

    print("\nGenerating point cloud...")
    cloud = generate_point_cloud(1, 0, 0, 1, 500)
    print("Cloud shape:", cloud.shape)       # should be (500, 4)
    print("Sample point:", cloud[0])



"""
fac(n) (done)
associated_laguerre(p, q, x) (done) 
assoc_legendre(l, m, x) (done)
radial_wavefunction(n, l, r, Z)(wdone)
spherical_harmonic(l, m, theta, phi)
probability_density(r, theta, phi, n, l, m, Z)
to_cartesian(r, theta, phi)
generate_point_cloud(n, l, m, Z, num_points)
get_energy(n, Z)
"""